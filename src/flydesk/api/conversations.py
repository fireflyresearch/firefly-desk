...
from flydesk.api.deps import get_audit_logger, get_conversation_repo, get_folder_repo
...
# ---------------------------------------------------------------------------
# Endpoints — Folder routes MUST be registered before /{conversation_id}
# to prevent the path parameter from shadowing literal "/folders".
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Folder Endpoints — registered before /{conversation_id} catch-all
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Conversation by ID endpoints (catch-all — must be after /folders)
# ---------------------------------------------------------------------------
...
async def delete_conversation(
    conversation_id: str, request: Request, repo: Repo, audit: Audit
) -> Response:
    ...
    await audit.log(AuditEvent(
        event_type=AuditEventType.CONVERSATION_DELETE,
        user_id=user_id,
