...
PLATFORM_DOCUMENTS: list[KnowledgeDocument] = [
    ...
    KnowledgeDocument(
        ...
        content=(
            ...
            " FLYDESK_CREDENTIAL_ENCRYPTION_KEY. Credentials are decrypted only at"
            ...
            " The trail is retained for FLYDESK_AUDIT_RETENTION_DAYS (default: 365)."
        ),
    ...
    KnowledgeDocument(
        ...
        content=(
            ...
            "Authentication is only enforced when FLYDESK_DEV_MODE=false. In"
            ...
            "Claim Mapping\n\n"
            "The FLYDESK_OIDC_ROLES_CLAIM and FLYDESK_OIDC_PERMISSIONS_CLAIM"
            ...
            "The FLYDESK_OIDC_PROVIDER_TYPE variable selects provider-specific"
            ...
            " FLYDESK_OIDC_ROLES_CLAIM value. Use GET /api/auth/me to see what"
    ...
    KnowledgeDocument(
        ...
        content=(
            ...
            "Configuration\n\n"
            "FLYDESK_FILE_STORAGE_PATH (default: ./uploads) controls where files are"
            " stored. FLYDESK_FILE_MAX_SIZE_MB (default: 50) sets the maximum file"
    ...
    KnowledgeDocument(
        ...
        content=(
            "Firefly Desk is configured via environment variables with the FLYDESK_"
            " prefix, or a .env file at the project root.\n\n"
            "Mode: FLYDESK_DEV_MODE (default: true) -- development mode disables"
            " auth, uses SQLite, and a synthetic user.\n\n"
            "Database: FLYDESK_DATABASE_URL (default:"
            " sqlite+aiosqlite:///flydesk_dev.db), FLYDESK_REDIS_URL (optional).\n\n"
            "OIDC (required when dev_mode=false): FLYDESK_OIDC_ISSUER_URL,"
            " FLYDESK_OIDC_CLIENT_ID, FLYDESK_OIDC_CLIENT_SECRET,"
            " FLYDESK_OIDC_SCOPES (default: openid,profile,email,roles),"
            " FLYDESK_OIDC_REDIRECT_URI (default:"
            " http://localhost:3000/auth/callback), FLYDESK_OIDC_ROLES_CLAIM"
            " (default: roles), FLYDESK_OIDC_PERMISSIONS_CLAIM (default:"
            " permissions), FLYDESK_OIDC_PROVIDER_TYPE (default: keycloak),"
            " FLYDESK_OIDC_TENANT_ID.\n\n"
            "CORS: FLYDESK_CORS_ORIGINS (default:"
            " http://localhost:3000,http://localhost:5173).\n\n"
            "Agent: FLYDESK_AGENT_NAME (default: Ember),"
            " FLYDESK_AGENT_INSTRUCTIONS, FLYDESK_MAX_TURNS_PER_CONVERSATION"
            " (default: 200), FLYDESK_MAX_TOOLS_PER_TURN (default: 10).\n\n"
            "Knowledge: FLYDESK_EMBEDDING_MODEL (default:"
            " openai:text-embedding-3-small), FLYDESK_EMBEDDING_DIMENSIONS"
            " (default: 1536), FLYDESK_RAG_TOP_K (default: 3),"
            " FLYDESK_KG_MAX_ENTITIES_IN_CONTEXT (default: 5).\n\n"
            "Security: FLYDESK_CREDENTIAL_ENCRYPTION_KEY,"
            " FLYDESK_AUDIT_RETENTION_DAYS (default: 365),"
            " FLYDESK_RATE_LIMIT_PER_USER (default: 60).\n\n"
            "File Uploads: FLYDESK_FILE_STORAGE_PATH (default: ./uploads),"
            " FLYDESK_FILE_MAX_SIZE_MB (default: 50).\n\n"
            "Branding: FLYDESK_APP_TITLE (default: Firefly Desk),"
            " FLYDESK_APP_LOGO_URL, FLYDESK_ACCENT_COLOR (default: #2563EB)."
        ),
    ...
    KnowledgeDocument(
        ...
        content=(
            ...
            " dependencies. Check FLYDESK_DATABASE_URL for connection errors. For"
            " PostgreSQL, verify the server is running and the pgvector extension"
            " is installed.\n\n"
            "Frontend Cannot Reach the API\n\n"
            "Verify FLYDESK_CORS_ORIGINS includes the frontend's origin. The match"
            " is exact: http://localhost:5173 is not http://127.0.0.1:5173. Check"
            " that the backend is running on port 8000.\n\n"
            "OIDC Authentication Failures\n\n"
            "Callback failures: Verify FLYDESK_OIDC_REDIRECT_URI exactly matches"
            " the provider's configuration. Missing roles: Verify"
            " FLYDESK_OIDC_ROLES_CLAIM matches the JWT structure. Decode tokens at"
            ...
            " download: Verify FLYDESK_FILE_STORAGE_PATH is consistent across"
            " instances.\n\n"
            ...
            "File Upload Issues\n\n"
            "Size errors: Increase FLYDESK_FILE_MAX_SIZE_MB. Empty extraction:"
            " Only text-based formats are extracted. Permission errors: Ensure"
            " FLYDESK_FILE_STORAGE_PATH exists and is writable.\n\n"
            "Widget Rendering\n\n"
