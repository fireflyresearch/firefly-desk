...
_DEFAULT_EXA_API_URL = "https://api.exa.ai"
...
class ExaAdapter:
    ...
    def __init__(
        ...
        api_key: str,
        *,
        api_url: str = _DEFAULT_EXA_API_URL,
        max_results: int = 5,
    ) -> None:
    ...
    async def _do_search(
        ...
        payload: dict = {
            ...
            "contents": {
                "highlights": True,
                **({"text": True} if include_content else {}),
            },
        }
        ...
        for item in data.get("results", []):
            ...
            snippet = " ".join(highlights) if highlights else item.get("title", "")
...
SearchProviderFactory.register("exa", ExaAdapter)
