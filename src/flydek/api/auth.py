...
from flydek.auth.oidc import OIDCClient, generate_pkce_pair
from flydek.auth.providers import get_provider as get_provider_profile
...
async def logout(
    ...
    response.delete_cookie(key="flydek_token", path="/")
