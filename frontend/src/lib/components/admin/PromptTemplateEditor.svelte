...
<div class="flex h-full flex-col gap-4 p-6">
	...
	{#if successMessage}
		<div
			class="shrink-0 rounded-xl border border-success/30 bg-success/5 px-4 py-2.5 text-sm text-success"
		>
			<div class="flex items-center gap-2">
	...
	{:else}
		<div class="flex min-h-0 flex-1 gap-4 overflow-hidden">
			<!-- Template list -->
			<div
				class="flex w-64 shrink-0 flex-col overflow-hidden rounded-lg border border-border bg-surface"
			>
				<div
					class="shrink-0 border-b border-border bg-surface-secondary px-3 py-2 text-xs font-medium text-text-secondary"
				>
